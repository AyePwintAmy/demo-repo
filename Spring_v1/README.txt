...
1) Go to src/main/resources and click on the application.properties. Change the schema name to the schema name in your MySQL Workbench. Change the spring.datasource.username and spring.datasource.password to your username and password accordingly.
